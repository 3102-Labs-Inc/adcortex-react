...
class AdcortexChatClient {
   ...
   */
  async call(role: string, content: string): Promise<Record<string, any> | null> {
   ...
   * @private
   */
  async _fetch_ad(): Promise<Record<string, any> | null> {
   ...
   * @private
   */
  async _send_request(payload: Record<string, any>): Promise<Record<string, any> | null> {
    try {
